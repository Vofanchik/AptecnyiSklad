...
class Ui_DialogResidue(object):
    def setupUi(self, DialogResidue):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(10, 10, 831, 521))
        ...
        self.horizontalLayoutWidget = QtWidgets.QWidget(DialogResidue)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 540, 821, 51))
